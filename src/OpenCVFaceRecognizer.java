...
public class OpenCVFaceRecognizer {
    public static void main(String[] args) {
        String trainingDir = "myimages"; //args[0];
        Mat testImage = imread("test/0.jpg", CV_LOAD_IMAGE_GRAYSCALE);
        ...
        System.out.println("File length = "+imageFiles.length);
        ...
        for (File image : imageFiles) {
            ...
            //System.out.println(">>"+image.getName().split("_")[1]);
            //System.out.println(image.getName().split("_")[1].split("[.]")[0]);
